...
import { AgeGroup, calcNewRegime, calcOldRegime } from "@/lib/calculations/income-tax/income-tax-engine";
...
export function IncomeTaxCalculator() {
  ...
  const result = useMemo(() => {
    ...
    const newRes = calcNewRegime(gross);
    const oldRes = calcOldRegime(gross, age, {
